...
DesignPackage generateDesign(Color primaryColor, Color backgroundColor, Color boxBackground, Color textColor, Color contrastColor, bool overrideIconColor) {
  return DesignPackage(
      ...
      textStyles: TextStyles(
          ...
          pageSubtitle: TextStyle(fontWeight: FontWeight.w600, fontSize:19, color: textColor.withOpacity(0.8)),
          boxHeadline: TextStyle(fontWeight: FontWeight.w700, fontSize:20, height: 1, color: textColor),
          pointElementPrimary: TextStyle(fontWeight: FontWeight.w500, fontSize:16 ,height: 1, color: textColor.withOpacity(0.9)),
