...
String desktopThemeIconSvg = '''
  <svg width="373" height="239" viewBox="0 0 373 239" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect width="373" height="239" rx="10" fill="#F1F1F1"/>
    <path d="M137 40H209V57H137V40Z" fill="#303540"/>
    <path d="M137 103H179V111H137V103Z" fill="#303540"/>
    <path d="M137 25H145V34H137V25Z" fill="#303540"/>
    <path d="M49 24C49 21.7909 50.7909 20 53 20H123C125.209 20 127 21.7909 127 24V215C127 217.209 125.209 219 123 219H53C50.7909 219 49 217.209 49 215V24Z" fill="white"/>
    <rect x="137" y="63" width="46" height="33" rx="4" fill="#9B9B9B"/>
    <rect x="188" y="63" width="45" height="33" rx="4" fill="white"/>
    <rect x="137" y="116" width="200" height="51" rx="4" fill="white"/>
    <rect x="56" y="27" width="64" height="16" fill="#303540"/>
    <path d="M56 63C56 61.8954 56.8954 61 58 61H118C119.105 61 120 61.8954 120 63V72C120 73.1046 119.105 74 118 74H58C56.8954 74 56 73.1046 56 72V63Z" fill="#9B9B9B"/>
    <rect x="298" y="201" width="37" height="16" rx="8" fill="#9B9B9B"/>
    <path fill-rule="evenodd" clip-rule="evenodd" d="M363 6H10C7.79087 6 6 7.79086 6 10V229C6 231.209 7.79086 233 9.99999 233H363C365.209 233 367 231.209 367 229V10C367 7.79086 365.209 6 363 6ZM10 0C4.47715 0 0 4.47716 0 10V229C0 234.523 4.47715 239 9.99999 239H363C368.523 239 373 234.523 373 229V10C373 4.47715 368.523 0 363 0H10Z" fill="#9B9B9B"/>
  </svg>
''';